    ...
    >
      ...
      <div className="mr-[60px] flex gap-3 font-semibold">
        <button
          ...
          className="rounded-md border border-[#0c172e] px-[9px] py-[4px] text-[#feffff] hover:bg-[#172A42]"
        >
          Log-in
        </button>
        <button
          onClick={() => navigate("/auth/sign-up")}
          className="rounded-md px-[10px] py-[5px] text-[#feffff] bg-[#0c172e] hover: hover: hover:bg-[#172A42]"
        >
          Register
        </button>
      </div>
