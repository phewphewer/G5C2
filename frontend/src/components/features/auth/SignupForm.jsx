...
<div className="w-full min-h-screen flex flex-col justify-center items-center bg-[#0c172e] p-4">
      ...
      <div className="w-full max-w-lg rounded-[5px]">
        <div className="w-full py-4 flex bg-[#d28033] rounded-t-[5px] items-center border-b-8 border-b-[#feffff]">
          <h1 className="text-2xl md:text-3xl font-extrabold ml-5">SIGN UP</h1>
        </div>
        {/* SIGN UP FORM start */}
        <form className="flex flex-col w-full bg-[#283D55] rounded-b-[5px] p-6">
          <div className="w-full space-y-4">
            ...
            <div className="w-full">
              <p className="font-bold text-sm md:text-base">Enter a valid username:</p>
              <input
                type="text"
            ...
            {/* PASSWORD */}
            <div className="w-full">
              <p className="font-bold text-sm md:text-base">Enter a valid password:</p>
            ...
            {/* REPEAT PASSWORD */}
            <div className="w-full">
              <p className="font-bold text-sm md:text-base">Re-enter password:</p>
              <input
                type="password"
                className="placeholder:italic bg-[#0c172e] rounded-[5px] w-full py-2 px-3 mt-1"
