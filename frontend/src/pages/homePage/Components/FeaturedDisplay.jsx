  ...
  return (
    <>
      <div className="w-1/4 p-4 pt-8">
        <div className="bg-[#00c1b1]/70 hover:bg-[#00c1b1] text-[#F7FAFC]/80 hover:text-[#F7FAFC] min-w-80 p-4 rounded-lg hover:border-[#ffffff] border-[#bdbdbd] z-0 border-2 sticky top-10 transition duration-300 ease-in-out">
